...
public class TenantWiseCollectionRowMapper implements ResultSetExtractor<HashMap<String, BigDecimal>>{
	...
	public HashMap<String, BigDecimal> extractData(ResultSet rs) throws SQLException, DataAccessException {
		...
		while(rs.next()) {
			...
			BigDecimal totalCollection = rs.getBigDecimal("totalamt");

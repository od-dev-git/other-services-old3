...
CONSTRAINT uk_eg_sr_service_v2 UNIQUE (id),
CONSTRAINT pk_eg_sr_serviceReq_v2 PRIMARY KEY (tenantId,serviceRequestId)
);

CREATE TABLE eg_sr_address_v2 (
...
CONSTRAINT pk_eg_sr_address_v2 PRIMARY KEY (id),
CONSTRAINT fk_eg_sr_address_v2 FOREIGN KEY (parentid) REFERENCES eg_sr_service_v2 (id)
);

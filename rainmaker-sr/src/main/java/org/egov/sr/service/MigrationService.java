...
import org.egov.sr.repository.rowmapper.ActionInfoRowMapper;
import org.egov.sr.repository.rowmapper.AddressRowMapper;
    ...
    public void migrateData(RequestInfo requestInfo, MigrationCriteria migrationCriteria){
        ...
        for(String tenantId : tenantIds){
            ...
            while (true){
                ...
                List<org.egov.sr.model.Service> services = jdbcTemplate.query(finalQuery, preparedStmtList.toArray(), svcRowMapper);

...
public class WorkFlowConfigs {
	...
	private static Map<String, List<String>> prepareActionCurrentStatusMap() {
		...
		map.put(ACTION_CLOSE, Arrays.asList(STATUS_RECEIVED_L2, STATUS_RECEIVED_L3, STATUS_OPENED));
	...
	private static Map<String, List<String>> prepareRoleActionMap() {
		...
		map.put(PGRConstants.ROLE_L1, Arrays.asList(ACTION_OPEN, ACTION_CLOSE, ACTION_FORWARD_TO_L2));
		map.put(PGRConstants.ROLE_L2, Arrays.asList(ACTION_FORWARD_TO_L3, ACTION_CLOSE));

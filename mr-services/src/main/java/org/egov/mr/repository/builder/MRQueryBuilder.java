...
public class MRQueryBuilder {
    ...
    private static final String QUERY = "SELECT mr.*,mrp.*,mrc.*,mrca.*," +
            ...
            "mrw.id as mrw_id,mrw.title as mrw_title,mrw.firstname as mrw_firstName,mrw.dateofbirth as mrw_dateofbirth,mrw.country as mrw_country,mrw.state as mrw_state,mrw.district as mrw_district,mrw.pincode as mrw_pincode,mrw.contact as mrw_contact," +

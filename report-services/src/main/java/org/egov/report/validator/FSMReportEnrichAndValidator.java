...
@Component
@Slf4j
public class FSMReportEnrichAndValidator {
	...
	public void validateFSMDataMartReport(UtilityReportSearchCriteria searchCriteria) {

		if (StringUtils.isEmpty(searchCriteria.getReportType())) {
			throw new CustomException("INVALID_REPORT_TYPE", "Kindly provide the Report Type to Proceed !!!");
		}
